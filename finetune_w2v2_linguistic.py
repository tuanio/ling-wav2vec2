...
model = Wav2VecForLinguisticTonalForCTC.from_pretrained('./w2v2_ablation_200epoch-with_ling_head-0drop-0load_best-best_on_tp0.025_tl10_fp0.001_fl16')
# w2v2_ablation_200epoch-with_ling_head-0.1drop-0load_best-best_on_tp0.025_tl10_fp0.001_fl16
...
# run_name = 'w2v2_ablation_200epoch-with_ling_head-0.1drop-0load_best-best_on_tp0.025_tl10_fp0.001_fl16'
run_name = 'w2v2_ablation_200epoch-with_ling_head-0drop-0load_best-best_on_tp0.025_tl10_fp0.001_fl16'
...
# f = open('ablation_study/with_linguistic_head', 'a')

# print("Checkpoint:", run_name, file=f)

# def run_predict(subset, dataset):
#     output = trainer.predict(dataset)
#     # print(len(logits), logits[1].shape)
...
# subprocess.run(['bash', 'run_md_d.sh', 'ablation_study/with_linguistic_head'])
